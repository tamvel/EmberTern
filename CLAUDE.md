...
- **Branch state**: working on master. Latest milestones: **CHECK-constraint duplicate-row bugfix** + **Constraint Management Sprint V1** (Add/Drop for PK / FK / Check / Unique from the Ograniczenia sub-tab).
