...
| [16-stage8-smart-editing.md](16-stage8-smart-editing.md) | **Stage 8 — Smart Editing & Structural Assistance.** M1 **Structural Matching**: the one **Related Elements Highlighting** pipeline (selection occurrences + caret-symbol references + bracket pairs + BEGIN/END, as interchangeable producers) that unified the editor's two fragmented occurrence highlighters. M2 Snippets / M3 Snippet Engine / M4 Structural Selection still to come. | 2026-07-16 |
