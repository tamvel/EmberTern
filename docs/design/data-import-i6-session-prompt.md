...
Stan wejściowy:
  gałąź feat/data-import, I5 ZAMKNIĘTY (etap + szew domykający), 5568 testów zielonych, build 0/0.
...
Definition of Done:
  build 0/0 · pełny zestaw testów zielony (baza 5568) · aplikacja startuje czysto ·
