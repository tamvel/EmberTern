...
| **Suite** | **7301**, zielony w trzech partycjach (**7184 + 63 + 54**). ⚠ Partycja headless ma **siedem** klas — `MetadataTreeVirtualizationProbe` (15b) i `SharedContextMenuFeasibilityProbe` (M3.4b) też są **w filtrze**; `StatusProgressSourcesTests` (M3b.1) **NIE** — nie konstruuje kontrolek Avalonii. **Mierz przed cytowaniem** |
| **Smoke** | czysty |
| **Drzewo** | czyste |
