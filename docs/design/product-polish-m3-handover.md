...
| **Smoke** | czysty |
| **Drzewo** | czyste |
| **NASTĘPNY KROK** | ⏸⏸ **PEŁNE QA WIZUALNE CAŁEGO ETAPU — cały język kolorów jest WDROŻONY (K1–K7, `product-polish.md` §19.15–§19.17).** ⛔ Nie dokładaj kolejnych zmian kolorów przed tym QA. Oceniamy **spójność całej aplikacji naraz, w obu motywach** — tak ustalił użytkownik, bo pojedyncze kroki trudno ocenić w oderwaniu od reszty. Punkty do obejrzenia: dwie czerwone ikony w nagłówku Saved Queries (§19.16.4) · pasek tytułu po zdjęciu koloru z „Odśwież" (§19.17.3) · **O‑4 Connect** i **O‑5 Security Manager** (§19.17.5) — dwie świadomie otwarte pozycje do rozstrzygnięcia na całym pasku naraz |
