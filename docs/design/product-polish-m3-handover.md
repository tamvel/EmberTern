...
| **Etap** | M0 ✅ · M1 ✅ · M2a ✅ · M2b ✅ · M2c ✅ (odebrane 2026-08-02) · **M3 — iteracja 0 zakończona** |
...
|---|---|---|---|
| 1 | **M3.1a** | Rytm pionowy chromy — `Size.TabIndicator` (nowy token), podłączenie `Size.TitleBar` / `Size.StatusBar` / `Size.Row.Tab` | **DA** |
