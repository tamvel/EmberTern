...
**Etap order:** **✅ ① Preview + Full (complete)** → **✅ ② Full smart-guarding/large-result polish** → **③ Export Framework (core + CSV/TXT/Clipboard, + `[Export all…]`)** ← NEXT → **④ XLSX** → **⑤ Activity Monitor**. Then, later: Benchmark, Export Script, remaining grid consumers.
