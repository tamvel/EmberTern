...
**Status: 🔒 PROJEKT ZAMROŻONY (2026-07-26). Etapy I0–I5 zaakceptowane; I6 dostarczony, czeka na potwierdzenie.**
...
| **⏳ I6 — DOSTARCZONY, czeka na wizualne potwierdzenie** | Sekcja **Cel** (istniejąca tabela) + panel **Mapowanie** + łańcuch przeliczeń rozszerzony o cel i mapowanie. Build 0/0, testy zielone, aplikacja startuje czysto; **wygląd w obu paletach niezweryfikowany** |
